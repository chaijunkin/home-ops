...
- `mcpo.cloudjur.com` - default/mcpo (parent: envoy-internal)
...
- `romm.cloudjur.com` - media/romm (parent: envoy-internal)
...
- `alloy.cloudjur.com` - observability/alloy (parent: envoy-internal)
...
- 10.10.30.1 - default/cyberchef (port: 8000)
...
- 10.10.30.14 - media/plex (port: 32400)
- 10.10.30.51 - observability/grafana (port: 80)
```
